...
#    return img_padded, scaler, [offset_x, offset_y]        # Offsets are the offset for padding in case one of the sides is less than 368 in length
#
#
